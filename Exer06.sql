...
update Funcionario SET Salario = Salario * 1.10 where departamentoid = 20;

update Funcionario SET Admissao = (STR_TO_DATE(DATE_FORMAT(NOW(), '%d/%m/%y'), '%d/%m/%y')) where idfuncionario = 500;

-- update Funcionario SET Admissao = NOW() WHERE idfuncionario = 500;
